...
| **Large batch readability** | Prefer smaller, reviewable batch chunks (for example 10-15 operations) so failures are easier to isolate, rerun, and inspect. Current `develop` has been validated by the latest full Round3 manual audit. |
